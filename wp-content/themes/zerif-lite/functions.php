...
function zerif_scripts() {    
    ...
    wp_enqueue_style('owl_theme_style', get_template_directory_uri() . '/css/owl.theme.css');
...
function zerif_custom_excerpt_length( $length ) {
	return 25;
}
add_filter( 'excerpt_length', 'zerif_custom_excerpt_length', 999 );
